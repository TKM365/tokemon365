...
Value getmininginfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("Stake Interest",    (uint64_t)GetProofOfStakeReward));
...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "Tokemon365 is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "Tokemon365 is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Tokemon365 is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Tokemon365 is downloading blocks...");
